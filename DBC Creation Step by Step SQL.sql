...
-- Run quest_template_update.sql
-- sudo mysql acore_world < quest_template_update.sql


INSERT INTO acore_world.player_race_stats (Race,Strength,Agility,Stamina,Intellect,Spirit) VALUES
	 (12,-3,2,0,3,-2);  -- FROM BELF. TODO insert from select better even if one row

	
	
INSERT INTO acore_world.playercreateinfo (race,class,`map`,`zone`,position_x,position_y,position_z,orientation) VALUES
